...
TEST_CASE("Unit_RTC_LinkerAPI_Negative", "[compiler]") {
...
TEST_CASE("Unit_RTC_LinkDestroy_Negative", "[compiler]") {
...
TEST_CASE("Unit_RTC_LinkDestroy_Default", "[compiler]") {
...
TEST_CASE("Unit_RTC_LinkerAPI", "[compiler]") {
...
TEST_CASE("Unit_RTC_LinkAddFile_Negative", "[compiler]") {
...
TEST_CASE("Unit_RTC_LinkAddFile_Default", "[compiler]") {
