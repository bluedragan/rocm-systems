...
// 
// Example application demonstrating how to use FINDROCm find_package
...
int test_hsa_runtime() {
    ...
    std::cout << "  1. Configure FINDROCm CMAKE config\n";
    std::cout << "  2. Install FINDROCm\n";
...
int main(int argc, char* argv[]) {
    print_separator("FINDROCm Test: HSA Runtime");
    
    std::cout << "This application demonstrates using find_package(FINDROCm)\n";
    ...
    if (result == 0) {
        ...
        std::cout << "✓ Application built with find_package(FINDROCm)\n";
    } else {
