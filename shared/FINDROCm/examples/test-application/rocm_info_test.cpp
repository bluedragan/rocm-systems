...
// and installation information using find_package(FINDROCm).
//
...
int main(int argc, char* argv[]) {
    print_separator("FINDROCm ROCm Information Test");
    ...
    std::cout << "✓ Application built successfully using find_package(FINDROCm)\n";
